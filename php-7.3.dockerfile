...
RUN curl -fsSL https://downloads.ioncube.com/loader_downloads/ioncube_loaders_lin_x86-64.tar.gz -o ioncube_loaders.tar.gz && \
    ...
    cp ioncube/ioncube_loader_lin_7.3.so /usr/local/php/lib/php/extensions/$EXT_DIR/ioncube_loader_lin_7.3.so && \
    echo "zend_extension=ioncube_loader_lin_7.3.so" >> /usr/local/php/php.ini && \
